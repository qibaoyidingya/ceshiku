...
class ListView
{
    ...
    function GetPageListST($list_len,$listitem="index,end,pre,next,pageno")
    {
		...
		*/
        ...
        for($j;$j<=$total_list;$j++)
        {
            if($j==$this->PageNo)
            {
                $listdd.= "<li class=\"thisclass nes\">$j</li>\r\n";
            }
            else
            {
                $listdd.="<li class=\"nes\"><a href='".str_replace("{page}",$j,$tnamerule)."'>".$j."</a></li>\r\n";
            }
        }
        $plist = '';
    ...
    function GetPageListDM($list_len,$listitem="index,end,pre,next,pageno")
    {
        ...
        for($j;$j<=$total_list;$j++)
        {
            if($j==$this->PageNo)
            {
                $listdd.= "<li class=\"thisclass nes\"><a>$j</a></li>\r\n";
            }
            else
            {
                $listdd.="<li class=\"nes\"><a href='".$purl."PageNo=$j'>".$j."</a></li>\r\n";
            }
        }
